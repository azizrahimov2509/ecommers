...
import Link from "next/link"; // Импортируем Link для кнопки "Назад"
          ...
          <div className="flex items-start justify-between gap-24">
            ...
            <div>
              ...
              <div className="flex gap-4 mb-6">
                ...
                <div className="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center text-white text-xl font-bold"></div>
                <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white text-xl font-bold"></div>
              </div>
              {/* Кнопки для размеров */}
              <div className="flex gap-4 mb-6">
                <button className="w-[86px] h-[46px] px-4 py-2 bg-gray-200 rounded-lg text-gray-700 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 text-base active:bg-black active:text-white">
                  Small
                </button>
                <button className="w-[86px] h-[46px] px-4 py-2 bg-gray-200 rounded-lg text-gray-700 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 text-base active:bg-black active:text-white">
                  Medium
                ...
                <button className="w-[100px] h-[46px] px-4 py-2 bg-gray-200 rounded-lg text-gray-700 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 text-base active:bg-black active:text-white">
                  X-Large
                </button>
              </div>
              <div className="flex items-center gap-4 mb-6">
                <div className="flex w-[170px] h-[52px]  gap-2 bg-slate-300 rounded-3xl p-3 items-center justify-between">
                  <button className="px-3 py-1  text-gray-700  focus:outline-none focus:ring-2 focus:ring-gray-400 text-2xl">
                    -
                  </button>
